...
public class AccommodationController {
    ...
    public ResponseEntity<ApiResponse<Page<AccommodationInfoResponse>>> searchAccommodations(
            ...
            @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDateTime checkinDay,
            @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDateTime checkoutDay
    ) {
        ...
        Page<AccommodationInfoResponse> page = accommodationService.searchAccommodations(checkinDay, checkoutDay, pageable);
